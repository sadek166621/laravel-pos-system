                ...
                <div class="panel-content">
                    ...
                    @if ($errors->any())
                        ...
                        <table class="table table-striped table-bordered nowrap table-hover" cellspacing="0" width="100%">
                            <h2 class="mb-xlg text-center" style="background-color: #1FBE9D ; font-weight: bold;"> Add Attendance
                        ...
                        <form action="{{ route('insent-attendace')}}" method="POST">
                            @csrf
                            ...
                            @foreach($attendace as $row)
                                <tr>
                                    ...
                                    <td>
                                        <input type="radio" name="attendance[{{ $row->id }}]" required value="present"> Present
                                        <input type="radio" name="attendance[{{ $row->id }}]" required value="absence"> Absence
                                    </td>
