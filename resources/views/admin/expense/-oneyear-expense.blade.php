...
<div class="content-header">
        ...
        <div class="leftside-content-header">
            <ul class="breadcrumbs">
                <li><i class="fa fa-table" aria-hidden="true"></i><a href="#">Expense Table</a></li>
                ...
                <div class="panel-content">
                    ...
                    @if ($errors->any())
                        ...
                        <h3 class="panel-title" style=" background-color: #1FBE9D; font-weight: bold; font-size:x-large; text-align: center">
                            Year Expenses {{date('Y',strtotime("-1 year"))}}
                        </h3>
                        <h5 class="text-center">
                            <a href="{{ route('-twoyr-expense') }}" class="btn btn-primary">{{ date("Y",strtotime("-2 year")) }}</a>
                            <a href="{{ route('year-expense') }}"class="btn btn-primary"> {{ date("Y")}}</a>
                        </h5>
                        <h4 class="text-center" style=" color:darkred;font-weight: bold;">Total: {{ $total }}৳</h4>
                        <h4 class="text-left" style=" color:black;font-weight: bold;">Today-Date: {{ date('d/m/Y') }}</h4><br>
