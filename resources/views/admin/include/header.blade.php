            ...
            <div class="leftside-header">
                <!-- <div class="logo">
                    <a href="index.html" class="on-click">
                        <img alt="logo" src="{{asset('AdminAssets')}}/images/header-logo.png" />
                    </a>
                </div> -->
                            ...
                            <div class="drop-content">
                                <div class="widget-list list-left-element">
                                    <ul>
                                        <li>
                                            <a href="#">
                                                <div class="left-element"><img alt="profile photo" src="{{asset('AdminAssets')}}/images/avatar/avatar_1.jpg" /></div>
                                                <div class="text">
                                        ...
                                        <li>
                                            <a href="#">
                                                <div class="left-element"><img alt="profile photo" src="{{asset('AdminAssets')}}/images/avatar/avatar_2.jpg" /></div>
                                                <div class="text">
                                        ...
                                        <li>
                                            <a href="#">
                                                <div class="left-element"><img alt="profile photo" src="{{asset('AdminAssets')}}/images/avatar/avatar_3.jpg" /></div>
                                                <div class="text">
                                        ...
                                        <li>
                                            <a href="#">
                                                <div class="left-element"><img alt="profile photo" src="{{asset('AdminAssets')}}/images/avatar/avatar_4.jpg" /></div>
                                                <div class="text">
                                        ...
                                        <li>
                                            <a href="#">
                                                <div class="left-element"><img alt="profile photo" src="{{asset('AdminAssets')}}/images/avatar/avatar_5.jpg" /></div>
                                                <div class="text">
                ...
                <div class="header-section" id="user-headerbox">
                    <div class="user-header-wrap">
                        <div class="user-photo">
                            <img alt="profile photo" src="{{asset('AdminAssets')}}/images/avatar/avatar_user.jpg" />
                        </div>
                        <div class="user-info">
